  ...
  return (
    <div
      className={`max-w-screen-2xl container  mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50
                    ${
                      sticky
                        ? "fixed sticky-navbar shadow-md bg-base-200 dark:bg-slate-600 dark:text-white duration-300 transition-all ease-in-out"
                        : "bg-transparent"
                    }`}
    >
      <div className="navbar ">
        ...
        {/* Right side of the Navbar Starts from here */}
        <div className="navbar-end space-x-3">
          {/* Div for the navItems which we create above to show them. */}
